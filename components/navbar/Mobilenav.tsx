...
export function SheetDemo({ 
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="right" className="w-[300px] sm:w-[400px] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 flex flex-col">
        <SheetHeader className="pb-2 shrink-0">
          <SheetTitle className="text-gray-900 dark:text-white">
            <Image className="h-10 w-auto object-cover" src="/logo.png" alt="logo" width={400} height={400} />
          </SheetTitle>
        ...
        <div className="flex flex-col items-center py-4 border-b border-gray-200 dark:border-gray-700 mb-2 shrink-0">
          {isAuthenticated && (
            <div className="flex flex-col items-center gap-2">
              <Image 
                className="h-16 w-16 rounded-full object-cover border-2 border-blue-500 dark:border-blue-400"
                src={profileImage}
        ...
        <div className="mt-auto pt-3 border-t border-gray-200 dark:border-gray-700 shrink-0">
          <SheetClose asChild>
