...
import { FaUserCircle, FaBookmark, FaFileAlt, FaCog } from "react-icons/fa";
...
const Navbar = async ({ userId }: NavbarProps) => {
  ...
  return (
    <div className="flex flex-col items-center bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
              {hasSession ? `Welcome back, ${userId}!` : "Hello, Guest"}
            </span>
          </div>
      ...
      {/* Navigation Bar */}
      <div className="min-h-[60px] w-full flex items-center gap-1 px-6 bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-gray-800 dark:to-gray-800/80 border-t border-gray-200 dark:border-gray-700">
        <Link
